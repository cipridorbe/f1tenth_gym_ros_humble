...
- Update correct parameter for path to map file:
  Go to [`config/sim.yaml`](https://github.com/cipridorbe/f1tenth_gym_ros_humble/blob/main/config/sim.yaml) and to [`f1tenth_gym_ros/gym_bridge.py`](https://github.com/cipridorbe/f1tenth_gym_ros_humble/blob/main/f1tenth_gym_ros/gym_bridge.py) in your cloned repo, change the `map_path` parameter to point to the correct location. It should be `'<your_home_dir>/sim_ws/src/f1tenth_gym_ros/maps/levine'`
